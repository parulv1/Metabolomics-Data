...
Patient_High_6mo = as.character(Coding$Subject[which(Coding$Key=="high-6mo")])
Patient_High_Day29 = as.character(Coding$Subject[which(Coding$Key=="high-Day29")])
Patient_High_Day8 = as.character(Coding$Subject[which(Coding$Key=="high-Day8")])
Patient_Low_6mo = as.character(Coding$Subject[which(Coding$Key=="low-6mo")])
Patient_Low_Day29 = as.character(Coding$Subject[which(Coding$Key=="low-Day29")])
Patient_Low_Day8 = as.character(Coding$Subject[which(Coding$Key=="low-Day8")])
